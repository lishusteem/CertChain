...
const ArticleForm = ({ onSubmit, isSubmitting }) => {
  ...
  // Adăugăm funcția pentru încărcarea datelor de test
  const loadMockData = () => {
    // Generăm un hash aleatoriu pentru conținut
...
* Crește transparența procesului jurnalistic`;
    ...
    // Actualizăm formData cu toate valorile mock
    setFormData({
    ...
    // Actualizăm și câmpul textarea care nu este direct legat de state
  ...
  // Generare link Ethereum pentru atestare
  const generateEthLink = async () => {
    try {
      // Codul pentru EAS contract și schema
      const EAS_CONTRACT_ADDRESS = "0xC2679fBD37d54388Ce493F1DB75320D236e1815e";
      
      // Generăm un link Ethereum pentru atestare 
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-grid">
          <div>
            ...
            <div className="form-group">
              ...
              <div className="markdown-editor">
                ...
                <textarea
                  ...
                  onChange={(e) => {
                    // Într-o aplicație reală, am calcula hash-ul aici
                    setFormData({
                      ...formData,
            ...
            {/* Butoane pentru funcționalități suplimentare */}
            <div style={{display: 'flex', gap: '1rem', marginBottom: '1.5rem'}}>
              {/* Buton pentru încărcarea datelor mock */}
              <button
                type="button"
              ...
              {/* Buton pentru generare link Ethereum */}
              <button
                type="button"
                className="button button-outline"
